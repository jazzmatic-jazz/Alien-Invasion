...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        #create a display window in pixels                            
    ...
    def _check_bullet_alien_collisions(self):
        ...
        if not self.aliens:
            #Destroy existing bullets anf create new fleet.
            self.bullets.empty()
            self._create_fleet()
    ...
    def _update_screen(self):
        """Update images on the screen, the flip to the new screen."""
    ...
    def _update_aliens(self):
        ...
        Update the positions of alll aliens in the fleet"""
    ...
    def _ship_hit(self):
        ...
        if self.stats.ships_left > 0:
            #Decrement ships_left, and upfate scoreboard.
...
if __name__=='__main__':
    #game instance and run the game
    ai=AlienInvasion()
    ai.run_game()
